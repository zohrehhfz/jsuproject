                    ...
                    <div class="chat-history">
                        ...
                        <ul>
                            ...
                            <div class=" w-100">
                                ...
                                <li class="clearfix" style="margin-left: 50vw;">
                                    <div class="float-right" style="background-color: #A1C4E7  ; border-radius:20px; width: fit-content; margin: auto;">
                                        <div class="float-right">
                                            <div class="d-inline" dir="ltr">
                                                <div class="d-inline" style="text-align: right;">
                                ...
                                <li class="clearfix" style="margin-right: 50vw;">
                                    <div class="float-left" >
                                        ...
                                        <div>
                                        <a href="{{route('ShowTravel',[$travel])}}"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" style="margin-right: -14px; margin-top: -3vh; color:red;" class="bi bi-trash-fill" viewBox="0 0 16 16">
